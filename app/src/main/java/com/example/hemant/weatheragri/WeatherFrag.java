package com.example.hemant.weatheragri;
...
import com.example.hemant.weatheragri.R;
...
public class WeatherFrag extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(WeatherFrag.this);
    ...
    protected void onDestroy() {
        ...
        if (locationManager != null) {
            try {
                locationManager.removeUpdates(WeatherFrag.this);
    ...
    private void preloadWeather() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(WeatherFrag.this);
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(WeatherFrag.this);
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WeatherFrag.this).edit();
    ...
    class TodayWeatherTask extends GenericRequestTask {
        public TodayWeatherTask(Context context, WeatherFrag activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(WeatherFrag.this);
            DashClockWeatherExtension.updateDashClock(WeatherFrag.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, WeatherFrag activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, WeatherFrag activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
