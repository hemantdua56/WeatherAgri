...
import com.example.hemant.weatheragri.BuildConfig;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.example.hemant.weatheragri.UPDATE_TIME";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int widgetId : appWidgetIds) {
            ...
            Intent intent2 = new Intent(context, WeatherFrag.class);
