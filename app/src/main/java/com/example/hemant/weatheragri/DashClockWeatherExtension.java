...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content:// com.example.hemant.weatheragri.authority");
    ...
    protected void onUpdateData(int reason) {
        ...
        try {
            ...
            publishUpdate(new ExtensionData()
                    .visible(true)
                    .icon(R.drawable.ic_cloud_black_18dp)
                    ...
                    .clickIntent(new Intent(this, WeatherFrag.class)));
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private String localize(SharedPreferences sp, String preferenceKey, String defaultValueKey) {
        return WeatherFrag.localize(sp, this, preferenceKey, defaultValueKey);
    }
