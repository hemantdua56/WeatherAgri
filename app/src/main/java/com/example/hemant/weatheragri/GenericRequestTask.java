...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    Context context;
    WeatherFrag activity;
    public int loading = 0;

    public GenericRequestTask(Context context, WeatherFrag activity, ProgressDialog progressDialog) {
    ...
    private URL provideURL(String[] coords) throws UnsupportedEncodingException, MalformedURLException {
        ...
        String apiKey = "d47c65a2cfe5cd0acf99be9524c8a6b0";
        ...
        urlBuilder.append("&appid=").append("d47c65a2cfe5cd0acf99be9524c8a6b0");
